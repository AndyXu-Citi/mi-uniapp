...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"马拉松报名小程序","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!**********************************************************!*\
  !*** C:/找工作/codebase/marathon-info/mi-uniapp/pages.json ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!******************************************************************!*\
  !*** C:/找工作/codebase/marathon-info/mi-uniapp/src/store/index.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  actions: {
    ...
    login: function login(_ref, userInfo) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var commit, _yield$uni$$u$api$log, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                commit = _ref.commit;
                _context.next = 3;
                return uni.$u.api.login(userInfo);
              case 3:
                _yield$uni$$u$api$log = _context.sent;
                data = _yield$uni$$u$api$log.data;
    ...
    getUserInfo: function getUserInfo(_ref2) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
        var commit, state, _yield$uni$$u$api$get, data;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return uni.$u.api.getUserInfo();
              case 3:
                _yield$uni$$u$api$get = _context2.sent;
                data = _yield$uni$$u$api$get.data;
...
/* 38 */
/*!**************************************************************************!*\
  !*** C:/找工作/codebase/marathon-info/mi-uniapp/src/utils/filters/index.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function currency(value) {
  ...
  if (!value && value !== 0) return "".concat(symbol, "0.00");
  return "".concat(symbol).concat(Number(value).toFixed(2));
}
 ...
 * @returns {string} 状态文本
 */
function status(value, statusMap) {
...
/* 39 */
/*!**************************************************************************!*\
  !*** C:/找工作/codebase/marathon-info/mi-uniapp/src/utils/mixins/global.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  methods: {
     ...
     * 显示确认对话框
     */
    showConfirm: function showConfirm(title, content) {
      return new Promise(function (resolve, reject) {
        uni.showModal({
          title: title,
          content: content,
     ...
     * 保存图片到相册
     */
    saveImageToPhotosAlbum: function saveImageToPhotosAlbum(url) {
      return new Promise(function (resolve, reject) {
        uni.downloadFile({
          url: url,
          success: function success(res) {
...
/* 40 */
/*!****************************************************************!*\
  !*** C:/找工作/codebase/marathon-info/mi-uniapp/src/api/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.userApi = exports.registrationApi = exports.favoriteApi = exports.eventApi = exports.default = void 0;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _index = _interopRequireDefault(__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '@/config/index.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
// 请求拦截器
...
var eventApi = {
  // 获取赛事列表
  getEventList: function getEventList(params) {
    return request({
      url: '/events',
      method: 'GET',
      data: params
  ...
  // 获取赛事详情
  getEventDetail: function getEventDetail(id) {
    return request({
  ...
  // 获取热门赛事
  getHotEvents: function getHotEvents() {
    return request({
      url: '/events/hot',
      method: 'GET'
    });
...
var favoriteApi = {
  ...
  // 取消收藏
  removeFavorite: function removeFavorite(eventId) {
    return request({
...
var registrationApi = {
  // 获取报名记录
  getRegistrations: function getRegistrations(params) {
    return request({
      url: '/registrations',
      method: 'GET',
      data: params
  ...
  // 创建报名
  createRegistration: function createRegistration(data) {
    return request({
      url: '/registrations',
      method: 'POST',
      data: data
  ...
  // 获取报名详情
  getRegistrationDetail: function getRegistrationDetail(id) {
    return request({
  ...
  // 取消报名
  cancelRegistration: function cancelRegistration(id) {
    return request({
      url: "/registrations/".concat(id),
      method: 'DELETE'
    });
...
/* 41 */
/*!*******************************************************************!*\
  !*** C:/找工作/codebase/marathon-info/mi-uniapp/src/utils/common.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function getPageParams() {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return _objectSpread(_objectSpread({}, options), uni.getLaunchOptionsSync().query);
}
